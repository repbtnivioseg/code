...
ggsave("integrated_vs_deaths.png", plot = plot, width = 10, height = 7, dpi = 300)
cat("\nBivariate plot saved successfully as 'integrated_vs_deaths.png'\n")
